...
impl From<WebSocket> for WebSocketByteStream {
...
impl AsyncWrite for WebSocketByteStream {
    ...
    fn poll_flush(
        ...
        self.project().socket.poll_flush(cx).map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e))
    }
    ...
    fn poll_shutdown(
        ...
        self.project().socket.poll_close(cx).map_err(|e| std::io::Error::new(std::io::ErrorKind::Other, e))
    }
}
